...
const GROUP_BOOST = 'boost';
    ...
    public static function initializeDefaults(): void
    {
        $defaults = [
            ...
            'login_rate_limit_attempts' => ['value' => 5, 'group' => self::GROUP_SECURITY, 'type' => 'number'],
            'login_rate_limit_minutes' => ['value' => 5, 'group' => self::GROUP_SECURITY, 'type' => 'number'],
            'registration_rate_limit_attempts' => ['value' => 5, 'group' => self::GROUP_SECURITY, 'type' => 'number'],
            'registration_rate_limit_minutes' => ['value' => 15, 'group' => self::GROUP_SECURITY, 'type' => 'number'],
            'password_reset_rate_limit_attempts' => ['value' => 5, 'group' => self::GROUP_SECURITY, 'type' => 'number'],
            'password_reset_rate_limit_minutes' => ['value' => 15, 'group' => self::GROUP_SECURITY, 'type' => 'number'],
            'verification_rate_limit_attempts' => ['value' => 6, 'group' => self::GROUP_SECURITY, 'type' => 'number'],
            'verification_rate_limit_minutes' => ['value' => 1, 'group' => self::GROUP_SECURITY, 'type' => 'number'],
