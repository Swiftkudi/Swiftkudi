...
Route::middleware(['web'])->group(function () {
    ...
    Route::middleware(['feature.access:marketplace'])->prefix('marketplace')->name('marketplace.')->group(function () {
        ...
        Route::get('/category/{slug}', [ListingController::class, 'category'])->name('listings.category');
        ...
        Route::middleware(['auth', 'check.email.required'])->group(function () {
            ...
            Route::put('/{id}/update', [ListingController::class, 'update'])->name('listings.update');
            Route::delete('/{id}/delete', [ListingController::class, 'destroy'])->name('listings.destroy');

            // Favourites
            Route::post('/{id}/favourite', [ListingController::class, 'toggleFavourite'])->name('listings.favourite');
        ...
        // -------------------------------------------------------------------
        Route::middleware(['auth', 'check.email.required', 'feature.access:marketplace'])->prefix('orders')->name('orders.')->group(function () {
        ...
        // -------------------------------------------------------------------
        Route::middleware(['auth', 'check.email.required'])->prefix('reviews')->name('reviews.')->group(function () {
        ...
        // -------------------------------------------------------------------
        Route::middleware(['auth', 'check.email.required'])->prefix('chat')->name('chat.')->group(function () {
        ...
        // -------------------------------------------------------------------
        Route::middleware(['auth', 'check.email.required'])->prefix('seller')->name('seller.')->group(function () {
        ...
        // -------------------------------------------------------------------
        Route::middleware(['auth', 'check.email.required'])->prefix('subscription')->name('subscription.')->group(function () {
