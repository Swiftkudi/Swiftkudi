...
<div class="py-8">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                ...
                <p class="mt-2 text-gray-600 dark:text-gray-400">
                    Manage your backlinks, influencers, newsletters, and leads
                </p>
            </div>
        ...
        <div class="border-b border-gray-200 dark:border-dark-700 mb-6">
            <nav class="flex space-x-8">
                ...
                <button onclick="showTab('active')"
                        class="py-3 px-1 border-b-2 font-medium text-sm tab-btn active"
                        data-tab="active">
                    Active ({{ isset($activeListings) ? $activeListings->count() : 0 }})
                </button>

                <button onclick="showTab('pending')"
                        class="py-3 px-1 border-b-2 font-medium text-sm tab-btn"
                        data-tab="pending">
                    Pending Review ({{ isset($pendingListings) ? $pendingListings->count() : 0 }})
                </button>
        ...
        <div id="tab-active" class="tab-content">
            ...
            @if(!isset($activeListings) || $activeListings->isEmpty())
                ...
                <div class="text-center py-12 bg-white dark:bg-dark-900 rounded-2xl shadow-lg">
                    ...
                    <a href="{{ route('growth.create') }}"
                       class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 mt-2 inline-block">
                    ...
                    @foreach($activeListings as $listing)
                        ...
                        <div class="bg-white dark:bg-dark-900 rounded-2xl shadow-lg shadow-gray-200/50 dark:shadow-dark-950/50 border border-gray-100 dark:border-dark-700 p-6">
                            ...
                            <div class="flex items-center gap-2 mb-2">
                                <span class="px-2 py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-400 text-xs rounded uppercase">
                                    {{ $listing->type }}
                                </span>
                            </div>
        ...
        <div id="tab-pending" class="tab-content hidden">
            ...
            @if(!isset($pendingListings) || $pendingListings->isEmpty())
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    @foreach($pendingListings as $listing)
                        ...
                        <div class="bg-white dark:bg-dark-900 rounded-2xl shadow-lg shadow-gray-200/50 dark:shadow-dark-950/50 border border-gray-100 dark:border-dark-700 p-6">
                            ...
                            <div class="flex items-center gap-2 mb-2">
                                <span class="px-2 py-1 bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-400 text-xs rounded">
                                    Pending Review
                                </span>
                            </div>
