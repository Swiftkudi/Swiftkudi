    ...
    <div class="max-w-3xl mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="bg-white dark:bg-dark-900 rounded-2xl border border-gray-100 dark:border-dark-700 p-5 shadow-md">
                ...
                @if($option['value'] === 'earner')
                    <a href="{{ route('onboarding.earner-type') }}" class="w-full inline-flex justify-center items-center gap-2 px-4 py-2 rounded-lg bg-indigo-600 text-white hover:bg-indigo-700 transition">Choose</a>
                @else
